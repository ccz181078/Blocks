...
public class UI_CreativeMode extends UI_MultiPage{
	...
	public UI_CreativeMode(){
		super();
		x=-7;y=0;
		addPage(new game.item.Stone(),new UI_ItemList(new ItemList_CreativeMode(_normal_item),pl.il));
		...
		addPage(new game.block.EnergyStoneBlock().asItem(),new UI_ItemList(new ItemList_CreativeMode(_circuit),pl.il));
		addPage(new game.block.StoneBlock().asItem(),new UI_ItemList(new ItemList_CreativeMode(_normal_block),pl.il));
		addPage(new game.block.WoodenBoxBlock().asItem(),new UI_ItemList(new ItemList_CreativeMode(_functional_block),pl.il));
	}
