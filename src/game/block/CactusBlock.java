...
private static final long serialVersionUID=1844677L;
	...
	public void touchEnt(int x,int y,Entity ent){
		if(ent instanceof game.entity.CactusMonster){
			ent.anti_g+=1;
			return;
		}
	...
	public boolean onUpdate(int x,int y){
		...
		if(dirt_v>3&&World._.get(x,y+1).isCoverable()){
			CactusBlock w=new CactusBlock();
			spread(w,0.2f);
			World._.place(x,y+1,w);
		}
		return false;
	}
}
