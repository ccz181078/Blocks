...
public abstract class Entity implements Serializable{
	...
	public void update(){
		...
		game.world.NearbyInfo ni=World.cur.getNearby(x,y,width(),height(),chk_block,false,true);
	...
	public final void updBlock(){
		if(chkRigidBody()){
			game.world.NearbyInfo ni=World.cur.getNearby(x+xv/2,y+yv/2,width()+abs(xv/2),height()+abs(yv/2),true,false,false);
	...
	public void add(){World.cur.newEnt(this);}//add to world
