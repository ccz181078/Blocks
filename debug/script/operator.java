...
class GetParamOp extends NotOp{
	void pop()throws ScriptException{
		Expr v=op_a();
		vals.push(new GetParam(v,LEFT,v.RIGHT));
	}
}
class ReturnOp extends NotOp{
	void pop()throws ScriptException{
		Expr v=op_a();
		vals.push(new Return(v,LEFT,v.RIGHT));
	}
}
class LambdaOp extends NotOp{
	void pop()throws ScriptException{
		Expr v=op_a();
		vals.push(new Lambda(v,LEFT,v.RIGHT));
	}
}
