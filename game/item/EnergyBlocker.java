...
public class EnergyBlocker extends Item implements BlockItem{
	private static final long serialVersionUID=1844677L;
	public static BmpRes[] bmp=BmpRes.load("Item/EnergyBlocker_",2);
	public BmpRes getBmp(){return bmp[tp];}
	static int tps[]={WireBlock.lr_block,WireBlock.ud_block};
	int tp=0;
