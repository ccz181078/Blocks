...
public class FastBall extends Vehicle{
	private static final long serialVersionUID=1844677L;
	private static BmpRes bmp[]=BmpRes.load("Armor/FastBall_",2);
	public BmpRes getBmp(){return bmp[0];}
	public BmpRes getJetBmp(){
		return Jetbmps[rndi(0,7)];
	}
	private static BmpRes bmp_gun[]=BmpRes.load("Armor/Gun_",2);
	static BmpRes Jetbmps[]=BmpRes.load("Entity/JetFire_",8);
	public BmpRes getArmorBmp(){
		return bmp[0];
		/*if(damage<900)return bmp[0+flag*3];
		if(damage<1800)return bmp[1+flag*3];
		return bmp[2+flag*3];*/
	}
	protected float maxReload(){return 1.6f;}
	public BmpRes getGunBmp(){return bmp_gun[cd>0?1:0];}
