...
private static final long serialVersionUID=1844677L;
	static BmpRes bmp=new BmpRes("Item/Quartz");
	...
	public void onVanish(double x,double y,Source src){
		...
		if(b.getClass()==StoneBlock.class){
			if(rnd()*4<1)World.cur.set(px,py,new QuartzOreBlock());
			return;
		}
		if(rnd()*16<1){
			new FallingBlock(px,py,new QuartzBlock()).initPos(x,y,0,0,src).add();
		}
	}
}
