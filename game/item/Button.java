...
import game.block.ButtonBlock;

public class Button extends Item implements BlockItem{
	private static final long serialVersionUID=1844677L;
	public static BmpRes[] bmp=BmpRes.load("Item/Button_",2);
	...
	public Item clickAt(double x,double y,game.entity.Agent a){
		...
		if(b.circuitCanBePlaced()){
			World.cur.setCircuit(px,py,new ButtonBlock(b));
			return null;
		}
