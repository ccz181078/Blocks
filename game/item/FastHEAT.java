...
public class FastHEAT extends Warhead{
private static final long serialVersionUID=1844677L;
	...
	public static void explode(double x,double y,double xv,double yv,double xv0,double yv0,boolean flag,Source src){
		...
		for(int i=-20;i<=20;i+=1){
			...
			Entity f;
			//if(i%5!=0){
				f=new HE_EnergyBall().setHpScale(2);
			//}else{
				//f=new ShockWave().setHpScale(2);
			//}
			double xv2=(xv*c1+yv*c2)*0.3;
			double yv2=(yv*c1-xv*c2)*0.3;
			double xv1=xv0+xv2;
			double yv1=yv0+yv2;
	...
	public Entity getBall(){
		return new HE_FireBall().setHpScale(2);
	}
