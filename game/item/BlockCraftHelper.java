...
public class BlockCraftHelper implements CraftHelper,DefaultEnergyContainer,java.io.Serializable{
	...
	public BlockCraftHelper(BlockAt _ba,EnergyContainer _ep){
		ba=_ba;
		ep=_ep;
	}
	...
	public EnergyContainer getEnergyContainer(){return ep;}
	public void upd(){
